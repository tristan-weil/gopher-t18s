...
{{      end -}}
{{/********** Display **********/ -}}
{{ ginfo (tablewriter (dict "data" (list (list "Go Stats")) "width" $width "text-alignment" "center" "box-draw-separate-rows" false "box-separator" "~" "box-left" ")" "box-right" ")")) }}
...
{{ ginfo (tablewriter (dict "data" (list (list "Cache status")) "width" $width "text-alignment" "center" "box-draw-separate-rows" false "box-separator" "~" "box-left" ")" "box-right" ")")) }}
{{ ginfo (tablewriter (dict "data" $cacheData "header-data" $cacheHeaderData "width" $width "text-alignment" "left")) }}

{{ ginfo (tablewriter (dict "data" (list (list "Active Connections")) "width" $width "text-alignment" "center" "box-draw-separate-rows" false "box-separator" "~" "box-left" ")" "box-right" ")")) }}
{{ ginfo (tablewriter (dict "data" $connActData "header-data" $connActHeaderData "width" $width "text-alignment" "left")) }}

{{ ginfo (tablewriter (dict "data" (list (list "Connections Duration (in ms)")) "width" $width "text-alignment" "center" "box-draw-separate-rows" false "box-separator" "~" "box-left" ")" "box-right" ")")) }}
{{ ginfo (tablewriter (dict "data" $connData "header-data" $connHeaderData "width" $width "text-alignment" "left")) }}

{{ ginfo (tablewriter (dict "data" (list (list "Template Processing (in ms)")) "width" $width "text-alignment" "center" "box-draw-separate-rows" false "box-separator" "~" "box-left" ")" "box-right" ")")) }}
{{ ginfo (tablewriter (dict "data" $procData "header-data" $procHeaderData "width" $width "text-alignment" "left")) }}
{{ end -}}
{{ template "footer.tpl" . }}
